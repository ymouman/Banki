...
*/
 public class ListSupCompte extends LayoutContainer {
   ...
   private void createForm2() {
     ...
     form2.setFrame(true);
     form2.setHeading("Supprimer un compte bancaire");
     form2.setWidth(500);
     form2.setHeight(350);
     form2.setLayout(new FlowLayout());

     FieldSet fieldSet = new FieldSet();
     fieldSet.setHeading("Informations des comptes");
     ...
     String htmltxt="<h3 align='center'>La liste de tous les ocmptes</h3><table align='center' border='0'><tr><td id='a'></td><td id='b'></td></tr></table><br><br><br>";
     ...
     final AsyncCallback<Boolean> callback = new AsyncCallback<Boolean>() {
            ...
            public void onSuccess(Boolean result) {
                lblServerReply.setText(result?"Compte supprimé avec succès":"Echec suppression!");
                getComptes();
            }
     ...
     save.addSelectionListener(new SelectionListener(){
            ...
            public void handleEvent(ComponentEvent e){
                ...
                if(msgerror == null ? "" != null : !msgerror.equals("")){
                    ...
                    getService().supprimeCompte(numcompte,  callback);
                    //lst.clear();
