...
*/
 public class CrediterCompte extends LayoutContainer {
   ...
   private void createForm2() {
     ...
     form2.setFrame(true);
     form2.setHeading("Créditer un compte bancaire");
     form2.setWidth(500);
     form2.setHeight(450);
     ...
     Solde.setFieldLabel("Montant à créditer");
     ...
     final AsyncCallback<Boolean> callback = new AsyncCallback<Boolean>() {
            ...
            public void onSuccess(Boolean result) {
                lblServerReply.setText(result?"Compte crédité avec succès":"Echec suppression!");
                getComptes();
            }
     ...
     Button save=new Button("Valider l'opération de crédit");
     ...
     save.addSelectionListener(new SelectionListener(){
            ...
            public void handleEvent(ComponentEvent e){
                ...
                if(msgerror == null ? "" != null : !msgerror.equals("")){
                    ...
                    String credit=Solde.getValue().toString();

                    getService().CrediterCompte(numcompte, Solde.getValue().toString(), callback);

                    Float restant=Float.valueOf(tab[1])-Float.valueOf(credit);
                    if(restant<0){
                        String  recip[]=new String[1];
                        Window.alert("Envoi de mail!!");
                        recip[0]="younes_mouman@live.fr";
                        
                            getService().postMail(recip, "Solde négatif", "votre solde est désormais négatif", "younes_mouman@live.fr", null);
                        
                    }
                    solde.setText(String.valueOf(restant));
